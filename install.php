...
<head>
  ...
  <title><?php echo APP_NAME; ?> - Instalacion</title>
    ...
    <div class="mx-auto mt-5 card card-login">
      ...
      <div class="card-body">
        <form method="POST">
          ...
          <h3 class="text-center">Crea Tu Cuenta De Administracion</h3>
          ...
          <div class="form-group">
            <div class="custom-control custom-checkbox">
              ...
              <label class="custom-control-label" for="EULA">Estoy De Acuerdo <a href="">EULA</a></label>
            </div>
          </div>
