...
<head>
  ...
  <title><?php echo APP_NAME; ?> - Centro De Operaciones</title>
      ...
      <div class="container-fluid">
        ...
        <?php if ($user->isTwoFAEnabled($_SESSION['username']) == false) : ?>
          ...
          <?php echo $utils->dismissibleAlert(
            "<b> Warning!</b> Su cuenta no está protegida por autenticación de dos factores. Habilite la autenticación de dos factores desde ahora. <a href=\"authsettings.php\" class=\"alert-link\">here</a>.",
            "Peligro",
