  <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
    <a class="navbar-brand mr-1" href="<?php echo SITE_URL; ?>/index.php">
      <img src="<?php echo SITE_URL; ?>/favico.png" width="30" height="30" alt=""><?php echo "OtterNet - Centro De Operaciones "; ?>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <!-- End Modules Handler -->
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" data-target="#logoutModal"><span class="fa fa-sign-out-alt"></span> Salir</a>
        </li>
      </ul>
    </div>
  </nav>